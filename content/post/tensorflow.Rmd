...
I'm loading a sample data set called ad_wx and convert some of my columns(feature candidates) to numeric data type for better building features for tensorflow. And you guessed it, ```{r}'AVG_weedday4'``,'AVG_weedday5' and 'ad_unit' will become my 3 features in my simple tensorflow model. 
